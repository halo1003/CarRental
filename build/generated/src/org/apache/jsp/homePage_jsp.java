...
public final class homePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                }\n");
      out.write("            }\n");
      out.write("            function checkEdit() {\n");
      out.write("                var pass = document.forms[\"EditForm\"][\"CPass\"].value;\n");
      out.write("                var repass = document.forms[\"EditForm\"][\"Re-CPass\"].value;\n");
      out.write("                var phone = document.forms[\"EditForm\"][\"CPhone\"].value;\n");
      out.write("                var address = document.forms[\"EditForm\"][\"CAddress\"].value;\n");
      out.write("                var name = document.forms[\"EditForm\"][\"CFName\"].value;\n");
      out.write("                if ( checkPassword(pass,repass) == 0 || checkFName(name) == 0 || checkPhone(phone) == 0 || checkAddress(address) == 0) {\n");
      out.write("                    return false;\n");
      out.write("                } else {\n");
      out.write("                    return true;\n");
      out.write("                }\n");
      ...
      out.write("                if (phone != \"\") {\n");
      out.write("                    if (phone.length > 11 || phone.length < 10) {\n");
      ...
      out.write("                    if (address.length > 50) {\n");
      out.write("                        alert(\"Address have a lot of characters\");\n");
      out.write("                        return 0;\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("            function checkFName(name) {\n");
      out.write("                if (name != \"\") {\n");
...
//Contact
      ...
      out.write("                        <form method=\"post\" action=\"check\" name=\"EditForm\" onsubmit=\"return checkEdit();\">\n");
