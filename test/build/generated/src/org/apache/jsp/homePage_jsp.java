...
public final class homePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("            <div class='topHomeR'><a href='Login.jsp'><div class=\"buttonLogin buttonColor\">Login</div></a></div>\n");
      out.write("            ");
...
///////////
      ...
      out.write("                <div class=\"optionLHeader \">\n");
      out.write("                    <form method=\"post\" action=\"homePage.jsp\">\n");
      out.write("                        <input type=\"hidden\" name=\"option\" value=\"fony\">\n");
      out.write("                        <input type=\"submit\" class=\"buttonHome\" value=\"o Fony\" >\n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
      out.write("                <form method=\"post\" action=\"homePage.jsp\">\n");
...
connection.close();
                        ...
                        } else if (option.equals("fony")) {
                            rs = statement.executeQuery("SELECT c.* FROM car c WHERE c.Status!='U' and (c.CarType = 'Fony') and (c.CarID not in (SELECT r.CarID FROM rent r))");
