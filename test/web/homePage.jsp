    ...
    <body>
        ...
        <div class="topHome">
            ...
            <%
                if (account.getID().equals("-1")) {
            %>
            <div class='topHomeR'><a href='Login.jsp'><div class="buttonLogin buttonColor">Login</div></a></div>
            <%
            } else if (account.getID().equals("0")) {%>
            <div class='topHomeR'>
        ...
        <div class="optionHome"><%///////////%>
            ...
            <div class="optionL">
                ...
                <div class="optionLHeader ">
                    <form method="post" action="homePage.jsp">
                        <input type="hidden" name="option" value="fony">
                        <input type="submit" class="buttonHome" value="o Fony" >
                    </form>
                </div>
                <form method="post" action="homePage.jsp">
